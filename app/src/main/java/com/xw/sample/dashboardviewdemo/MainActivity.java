...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private DashboardView2 mDashboardView5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDashboardView5 = (DashboardView2) findViewById(R.id.dashboard_view_5);
        ...
        mDashboardView5.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dashboard_view_2:
                mDashboardView2.setCreditValueWithAnim(new Random().nextInt(100));
            ...
            case R.id.dashboard_view_5:
                ...
                if (isAnimFinished) {
                    ObjectAnimator animator = ObjectAnimator.ofInt(mDashboardView4, "mRealTimeValue",
                            mDashboardView5.getCreditValue(),new Random().nextInt(100));
                    ...
                    animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                        ...
                        public void onAnimationUpdate(ValueAnimator animation) {
                            ...
                            mDashboardView5.setCreditValue(value);
                        }
                    });
                    animator.start();
                }
